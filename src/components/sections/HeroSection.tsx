    ...
    return (
        <section className="relative min-h-screen flex flex-col items-center justify-center text-center px-6 overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col items-center gap-6 max-w-2xl">
                ...
                <h1 className="font-serif text-5xl sm:text-6xl md:text-7xl lg:text-8xl text-olive leading-none tracking-tight animate-[fadeUp_0.8s_ease-out_0.2s_both]">
                    {dict.hero.names}
                </h1>

                <span className="ornament" />

                <p className="font-sans text-base md:text-lg text-stone font-light tracking-wide animate-[fadeUp_0.8s_ease-out_0.4s_both]">
                    {dict.hero.subtitle}
                </p>
                <p className="font-serif text-xl md:text-2xl text-olive/70 italic animate-[fadeUp_0.8s_ease-out_0.5s_both]">
                    {dict.hero.date}
                </p>
