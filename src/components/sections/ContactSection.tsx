            ...
            <div className="container-main">
                <div ref={ref} className="fade-in-section text-center">
                    ...
                    <div className="flex flex-col gap-3 max-w-lg mx-auto">
                        {/* Email — full width */}
                        <a
                            href="mailto:paulaoriol@gmail.com"
                        ...
                        >
                            ...
                            <div className="text-left">
                                <p className="font-sans text-xs tracking-widest uppercase text-stone mb-0.5">{c.email_label}</p>
                                <p className="font-sans text-sm font-medium text-[var(--color-text)]">paulaoriol@gmail.com</p>
                            </div>
                        </a>
